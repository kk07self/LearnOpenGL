...
@implementation MutipleScreenFilter
...
- (void)progress {
    ...
    glVertexAttribPointer(_inputTextureCoordinate, 2, GL_FLOAT, GL_FALSE, 0, [self textureCoordinates]);
...
- (void)setScreenStyle:(MutipleScreenFilterStyle)screenStyle {
